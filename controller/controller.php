...
function affichage_employe_modification2($id)
{
    $employe = new Employe();
    $employes = $employe->getemploye_id($id);
    $employes3= $employe->getemploye_id($id);
    $employes33=$employes3->fetch();
    if(!empty($employes33['respo']))
    {
        $employe333=$employe->getemploye_matricule($employes33['respo']);
        $employe333=$employe333->fetch();
    }
