    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="alert alert-success alert-dismissible row" style="margin-left: 150px; margin-right: 300px;" >
                ...
                Le certificat de travail a bien été généré ! Cliquer sur ce bouton pour le télécharger.
                <a class="btn btn-success glyphicon glyphicon-save" type="button" style="margin-left: 20px;"
                   href="generated/Contrat.docx" download></a>



            </div>
            <a href="index.php?id=<?=$_GET['id']?>&amp;action=info_employe" class="btn btn-light" style="margin-left: 740px;">Retour</a>
