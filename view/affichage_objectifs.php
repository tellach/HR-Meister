    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <a class="btn btn-success" type="button"
               href="index.php?matricule=<?= $_GET['matricule'] ?>&amp;action=affiche_page_ajouter_objectif"><i
                        class="fa fa-plus"></i> Ajouter un objectif</a>
        ...
        <section class="content container-fluid">
            ...
            <table id="tab-employe" class="display" width="100%" cellspacing="0">
                ...
                <?php
                $i = 1;
                while ($objectif = $req->fetch()) {
                    ?>
                    <tr>
                        <td><?php echo $objectif['objectif'] ?></td>
                        <td><?php echo $objectif['date_debut'] ?></td>
                        <td><?php echo $objectif['type'] ?></td>
                        <td><?php echo $objectif['Evaluation'] ?></td>
                        <?php $i++;
                        $id = $objectif['id']; ?>
                        <td>
                            <a class="btn btn-warning" type="button"
                               href="<?= 'index.php?action=modifier_affich__objectif&amp;id=' . $id . '&amp;matricule=' . $matricule; ?>">Modifier</a>
                            <a class="btn btn-danger" type="button"
                               href="<?= 'index.php?action=supprimer_objectif&amp;id=' . $id . '&amp;matricule=' . $matricule; ?>">Supprimer</a>
                        </td>
                    </tr>
                    <?php
                } ?>
