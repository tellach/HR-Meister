...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active menu-open">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="index.php?action=list_entretien_venir">Entretiens à venir</a></li>
                    </ul>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Calendrier des entretiens à venir
            </h1>
            </br>
            <a class="btn btn-success" type="button"
                    href="index.php?where=<?=3?>&amp;action=affich_ajoutembauche"><i class="glyphicon glyphicon-plus"></i> Ajouter un entretien</a>
        </section>
            ...
            <table id="tab-candidat" class="display" width="100%" cellspacing="0">
                ...
                while ($embauche = $embauches->fetch()) {                     ?>
                    <tr>
                        ...
                        <td><?php echo $embauche['datee'];$id = $embauche['id']; ?></td>
                        <td><a class="btn btn-success" type="button"
                               href="index.php?where=<?=3?>&amp;id=<?=$id?>&amp;action=commencer"><i class="glyphicon glyphicon-check"></i> Commencer</a>
                               <a class="btn btn-warning" type="button"
                               href="index.php?where=<?=3?>&amp;id=<?=$id?>&amp;action=modifier_embauche_affiche"><i class="fa fa-edit"></i> Modifier</a>
                               <a class="btn btn-danger" type="button"
                               href="index.php?where=<?=3?>&amp;id=<?=$id?>&amp;action=supprimer_embauche" style="margin-top: 5px; margin-left: 65px;"><i class="glyphicon glyphicon-remove"></i> Supprimer</a>
                        </td>
                    </tr>
                    <?php
                }?>
