    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class=""><a href="index.php?action=list_candidat"><i
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="box box-primary center-block" style="width:100%;">
                        ...
                        <form action="./index.php?where=<?= $where ?>&amp;emb=<?= $emb ?>&amp;action=ajouter_question1"
                            ...
                            <div class="box-body form-group">
                                ...
                                <div class="box-footer form-group">
                                    ...
                                    <a href="index.php?where=<?= $where ?>&amp;id=<?= $emb ?>&amp;action=info_embauche"
