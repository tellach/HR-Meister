                ...
                <div class="col-md-10">
                    <div class="box box-primary center-block" style="width:100%;">
                        <div class="box-header with-border">
                            <h3 class="box-title">Formulaire d'ajout d'une nouvelle question réponse</h3>
                        </div>
                        <form action="./index.php?where=<?= $where ?>&amp;emb=<?= $emb ?>&amp;action=ajouter_question"
                            ...
                            <div class="box-body form-group">
                                ...
                                <div class="box-footer form-group">
                                    ...
                                    <a href="index.php?where=<?= $where ?>&amp;id=<?= $emb ?>&amp;action=affichaccepter"
                                       class="btn btn-light pull-right">Terminer avec les questions</a>
                                </div>
                            </div>
                        </form>
                    </div>
