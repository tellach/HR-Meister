...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
               ...
               <li class="treeview active menu-open">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="index.php?action=list_entretien_today">Entretiens pour aujourd'hui</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Calendrier des entretiens pour aujourd'hui <?php echo date('d-m-Y') ?>
            </h1>
            </br>
            <a class="btn btn-success" type="button"
                    href="index.php?where=<?=2?>&amp;action=affich_ajoutembauche"><i class="glyphicon glyphicon-plus"></i> Ajouter un entretien</a>
        </section>
        ...
        <section class="content container-fluid">
            ...
            <table id="tab-candidat" class="display" width="100%" cellspacing="0">
                ...
                while ($embauche = $embauches->fetch()) {                    ?>
                    <tr>
                        <td><?php echo $embauche['matricule'] ?></td>
                        <td><?php echo $embauche['nom'] ?></td>
                        <td><?php echo $embauche['prenom']     ;$id = $embauche['id'];?></td>
                        <td><a class="btn btn-success" type="button"
                               href="index.php?where=<?=2?>&amp;id=<?=$id?>&amp;action=commencer_embauche_affiche"><i class="glyphicon glyphicon-check"></i> Commencer</a>
                            <a class="btn btn-warning" type="button"
                               href="index.php?where=<?=2?>&amp;id=<?=$id?>&amp;action=report_embauche1&amp;id=<?= $embauche['id'] ?>"><i class="glyphicon glyphicon-calendar"></i> Reporter</a>
                            <a class="btn btn-primary" type="button"
                               href="index.php?where=<?=2?>&amp;id=<?=$id?>&amp;action=info_embauche" style="margin-top: 5px; margin-left: 85px;"><i class="fa fa-info"></i> Info</a>
                        </td>
                    </tr>
                    <?php
                }  ?>
