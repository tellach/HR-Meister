...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active menu-open">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="index.php?action=list_conge_pass">Congés passés</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Liste des congés passés
            </h1>
            </br>
            <a type="button" href="index.php?action=affich_ajout_conge" class="btn btn-success"><i class="fa fa-plus"></i> Ajouter un congé</a>
        </section>
