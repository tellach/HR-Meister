...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="index.php?action=list_conge_venir">Congés à venir</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Modification d'un congé à venir
            </h1>
        ...
        <section class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="box box-primary center-block col " style="width:100%">
                        <div class="box-header with-border">
                            <h3 class="box-title">Formulaire de modification du congé à venir</h3>
                        </div>

                        <form role="form" method="POST"
                              action="index.php?modif=futur&action=modifier_conge&amp;id=<?= $_GET['id'] ?>&critere=date_debut">
                            <div class="box-body">
                                <div class="form-group col-lg-12 <?php if (isset($retour)&&($retour!="")&&($retour!="valide")&&($critere=="date_debut")) echo 'has-error' ?>">
                                    <label class="form-control">Date de début</label>
                                    <div class="input-group date">
                                        ...
                                        <input class="form-control" id="datepicker" type="text"
                                               value="<?php echo $date_debut ?>" name="date">

                                    </div>
                                    <!-- /.input group2 -->
                                    <?php if (isset($retour)&&($retour=="fin<debut")&&($critere=="date_debut")){ ?>
                                        <span class="help-block">La date du début ne peut pas être superieur à la date du fin !</span>
                                    <?php } ?>

                                    <?php if (isset($retour)&&($retour=="reste")&&($critere=="date_debut")){ ?>
                                    ...
                                    <?php if (isset($retour)&&($retour=="coupure")&&($critere=="date_debut")){ ?>
                                    ...
                                    <?php if (isset($retour)&&($retour=="debut>actuel")&&($critere=="date_debut")){ ?>
                        ...
                        <form role="form" method="POST"
                              action="index.php?modif=futur&action=modifier_conge&amp;id=<?= $_GET['id'] ?>&critere=date_fin">
                            <div class="box-body">
                                <div class="form-group col-lg-12 <?php if (isset($retour)&&($retour!="")&&($retour!="valide")&&($critere=="date_fin")) echo 'has-error' ?>">
                                    <label class="form-control">Date de fin</label>
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <?php $date_fin = $conge['date_fin'];/**/ ?>
                                        <input class="form-control" id="datepicker2" type="text"
                                               value="<?php echo $date_fin ?>" name="date">

                                    </div>
                                    <!-- /.input group2 -->
                                    <?php if (isset($retour)&&($retour=="fin<actuel")&&($critere=="date_fin")){ ?>
                                        <span class="help-block">La date du fin ne peut pas être infèrieur à la date actuelle !</span>
                                    <?php } ?>

                                    <?php if (isset($retour)&&($retour=="reste")&&($critere=="date_fin")){ ?>
                                        <span class="help-block">Le nombre de journée restante de congé pour cet employé est inferieur à la durée de ce congé ! Consulter les informations de cet employé pour plus d'info !</span>
                                    <?php } ?>

                                    <?php if (isset($retour)&&($retour=="coupure")&&($critere=="date_fin")){ ?>
                                        <span class="help-block">L'employé a déjà un congé en cette periode , Entrer une autre date ou consulter la liste des congés pour avoir plus d'info !</span>
                                    <?php } ?>

                                    <?php if (isset($retour)&&($retour=="fin<debut")&&($critere=="date_fin")){ ?>
                            ...
                            <div class="box-footer col-lg-12">
                                <button type="submit" class="btn btn-success">Valider</button>
                                <a href="index.php?action=list_conge_prez" class="btn btn-light pull-right">Retour</a>
                            </div>
                        </form>
