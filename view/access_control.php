...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="index.php?affichage_conge_global">Vue globale</a></li>
                    </ul>
                </li                </li>
                <li class="treeview">
    ...
    <div class="content-wrapper">
        ...
        | Your Page Content Here |
        -------------------------->
			<div class="callout callout-danger row" style="margin-left: 100px; margin-right: 150px;">
				<h4><i class="icon fa fa-ban"></i> Accés refusé !</h4>
				<br>
				<h4>Vous n'avez pas le droit pour acceder à cette page , veuillez consulter l'administrateur pour plus d'info !!</h4>
			</div>
		</section>
            <!-- /.content -->
