    ...
    <div class="content-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <section>
                ...
                <div class="alert alert-success alert-dismissible row" style="margin-left: 100px; margin-right: 300px;" >
                    <h4><i class="icon fa fa-check"></i> Succés!</h4>
                    Le fichier Excel 'Historique des salaire' a bien été généré. Cliquer sur ce bouton pour le télécharger.
                    <!-- <button class="btn btn-success glyphicon glyphicon-save" type="button" style="margin-left: 20px;"
                             href="Entretien.xlsx"></button>-->
                    <a href="generated/historique_des_salaires.xlsx" download="" class="btn btn-success glyphicon glyphicon-save" style="margin-left: 8px;">
                    </a>

                </div>
                <a href="index.php?id=<?=$empl1['id']?>&amp;action=historique_salaire" class="btn btn-light" style="margin-left: 740px;">Retour</a>
            </section>
            <!-- /.content -->
