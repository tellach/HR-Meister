    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <a class="btn btn-success" type="button"
               href="index.php?matricule=<?=$employes1['matricule']?>&amp;action=telecharger_historique"><i class="fa fa-upload"></i> Télécharger la fiche de paie</a>
        </section>

        <!-- Main content -->
        <section class="content container-fluid">
            <h3>Historique des salaires de <?php echo $employes1['nom'].' '.$employes1['prenom']; ?></h3>
            ...
            <table id="tab-conges" class="display" width="100%" cellspacing="0">
                ...
                while ($employe3 = $salaire->fetch()) {
                    ?>
                    <tr>
                        <td><?php echo $employe3['montant'] ?> DA</td>
                        <td><?php echo $employe3['date'] ?></td>
                    </tr>
                    <?php
                } ?>
                </tbody>
