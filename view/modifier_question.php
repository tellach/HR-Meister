                ...
                <div class="col-md-10">
                    <div class="box box-primary center-block" style="width:100%;">
                        <div class="box-header with-border">
                            <h3 class="box-title">Formulaire de modification d'une question réponse ... </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="index.php?where=<?= $where ?>&amp;emb=<?= $emb ?>&amp;id=<?= $_GET['id'] ?>&amp;action=modifier_question"
                              method="POST" enctype="multipart/form-data" role="form" id="contact_form">
                            ...
                            <div class="form-group box-body">
                                ...
                                <div class="form-group col-lg-12">
                                    <label for="reponse" class="control-label"> Réponse </label>
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="ion-alert"></i>
                                        </div>
                                        <input class="form-control" type="text" name="reponse"
                                               value="<?php echo $question['reponse']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="box-footer form-group">
                                    ...
                                    <a href="index.php?action=list_entretien_pass" class="btn btn-light pull-right">Retour</a>
