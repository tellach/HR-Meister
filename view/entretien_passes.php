...
<div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active menu-open">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="index.php?action=list_entretien_pass">Entretiens passés</a></li>
                ...
                <li><a href="index.php?where=<?=1?>&amp;action=modification_entreprise_afiiche"><i class="glyphicon glyphicon-cog"></i> <span>Paramètres généraux</span></a>
                </li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Calendrier des entretiens passés
            </h1>
            </br>
            <a class="btn btn-success" type="button"
                    href="index.php?action=affich_ajoutembauche"><i class="glyphicon glyphicon-plus"></i> Ajouter un entretien</a>
        </section>
                ...
                while ($embauche = $embauches->fetch()) {                    ?>
                    <tr>
                        ...
                        <td>
                               ...
                               href="index.php?where=<?=1?>&amp;id=<?=$id?>&amp;action=info_embauche"><i class="fa fa-info"></i> Info</a>
                        </td>
                    </tr>
                    <?php
                } ?>
