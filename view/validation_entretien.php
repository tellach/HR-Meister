      ...
      <!--------------------------
        ...
        <section>
            ...
            <div class="alert alert-success alert-dismissible row" style="margin-left: 100px; margin-right: 300px;" >
                ...
                Le fichier Excel a été bien généré cliquer sur ce bouton pour le télécharger
               <!-- <button class="btn btn-success glyphicon glyphicon-save" type="button" style="margin-left: 20px;"
                        href="Entretien.xlsx"></button>-->
                <a href="generated/Entretien.xlsx" download="" class="btn btn-success glyphicon glyphicon-save" style="margin-left: 20px;">
                </a>

            </div>
            <a href="index.php?id=<?=$id_employe?>&amp;action=info_employe" class="btn btn-light" style="margin-left: 750px;">Retour</a>
        </section>
    <!-- /.content -->
