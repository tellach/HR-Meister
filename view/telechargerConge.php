    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="alert alert-success alert-dismissible row" style="margin-left: 150px; margin-right: 300px;" >
                ...
                Le titre du congé a bien été généré ! Cliquer sur ce bouton pour le télécharger.
                <a class="btn btn-success glyphicon glyphicon-save" type="button" style="margin-left: 20px;"
                   href="generated/TitreConge.docx" download></a>



            </div>
            <a href="index.php?action=list_conge_prez" class="btn btn-light" style="margin-left: 740px;">Retour</a>
