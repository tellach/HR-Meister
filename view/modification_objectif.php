                ...
                <div class="col-md-10">
                    <div class="box box-primary center-block" style="width:100%;">
                        <div class="box-header with-border">
                            <h3 class="box-title">Formulaire de modification d'un objectif</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body form-group">
                            <form action="index.php?action=modifier_objectif&amp;matricule=<?= $objectifs['matricule'] ?>&amp;id=<?= $objectifs['id'] ?>"
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="<?php echo $objectifs['objectif']; ?>"
                                               name="objectif">
                                    </div>
                                </div>

                                <div class="form-group col-lg-12">
                                    <label class="control-label">Date objectif: <?php echo $objectifs['date_debut']; ?></label>
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" id="datepicker" class="form-control"
                                               value="<?php echo $objectifs['date_debut']; ?>" name="date">
                                    </div>
                                    <?php if (isset($error) && ($error == 'error')) { ?>
                                        <span class="help-block">La date  n'est pas valide !</span>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group">
                                        <!-- <input type="text" name="type_objectif">-->
                                        <select name="type_objectif" class="form-control">
                                            <option value="court terme" <?php if($objectifs['type']=="court terme") echo "selected"; ?>>court terme</option>
                                            <option value="moyen terme"<?php if($objectifs['type']=="moyen terme") echo "selected"; ?>>moyen terme</option>
                                            <option value="long terme"<?php if($objectifs['type']=="long terme") echo "selected"; ?>>long terme</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group">
                                        <select name="evaluation" class="form-control">
                                            <option value="A" <?php if($objectifs['	Evaluation']=="A") echo "selected";?>>Depasse</option>
                                            <option value="B"<?php if($objectifs['	Evaluation']=="B") echo "selected";?>>Atteint</option>
                                            <option value="C"<?php if($objectifs['	Evaluation']=="C") echo "selected";?>>Partiellement atteint</option>
                                            <option value="D"<?php if($objectifs['	Evaluation']=="D") echo "selected";?>>Non atteint</option>
                                            <option value="E"<?php if($objectifs['	Evaluation']=="E") echo "selected";?>>Abandonner</option>
                                        </select>
                                    </div>
                                </div>
