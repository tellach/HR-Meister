    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <table id="tab-employe" class="display" width="100%" cellspacing="0">
                ...
                while ($entretien2 = $entretien1->fetch()) {
                    ?>
                    <tr>
                        <td><?php echo $entretien2['date'] ?></td>
                        <td><?php echo $entretien2['score'] ?></td>
                        <?php  $id=$entretien2['id'];?>
                        <td><a class="btn btn-warning" type="button"
                               href="<?php echo $entretien2['fichier_excel'].'.xlsx'; ?>" download="" class="btn btn-success glyphicon glyphicon-save"><i class="fa fa-edit"></i> Visualiser</a>
                        </td>
                    </tr>
                    <?php
                } ?>
