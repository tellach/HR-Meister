    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <!--------------------------
              ...
              -------------------------->
            <div class="box box-primary center-block" style="width:550px;">
                <div class="box-header with-border">
                    <h3 class="box-title">Formulaire de modification du congé en cours de OUKACHA Fouzi</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="../index.php?action=modifier_conge&amp;id=<?= $_GET['id'] ?>&critere=date_fin" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <input name="date" class="form-control pull-right" id="datepicker2" type="text">
                            </div>
                            <!-- /.input group2 -->
                        </div>
                    </div>
                    ...
                    <div class="box-footer" style="padding-top:0;">
                        <a type="submit" class="btn btn-success">Ajouter</a>
