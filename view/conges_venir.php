...
<head>
    ...
    <link rel="stylesheet" href="public/dist/css/jquery.dataTables.min.css">
    <style>
        tfoot input {
            width: 100%;
            padding: 3px;
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <a type="button" class="btn btn-success" href="index.php?action=affich_ajout_conge"><i class="fa fa-plus"></i> Ajouter un congé</a>
        </section>
        ...
        <section class="content container-fluid">
            ...
            <table id="tab-conges" class="display" width="100%" cellspacing="0">
                ...
                while ($conge=$conges->fetch())
                {
                    ?>
                    <tr>
                        <td><?php echo $conge['matricule']?></td>
                        ...
                        <td>
                            <?php $id=$conge['id_conge']; ?>
                            <a class="btn btn-danger" type="button"
                               data-toggle="modal" data-target="#modal-danger<?php echo $id; ?>"><i class="fa fa-remove"></i> Supprimer</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a type="button" class="btn btn-outline" href="index.php?action=supprimer_conge&amp;id=<?= $conge['id_conge'] ?>">Supprimer</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                            ...
                            <a class="btn btn-warning" type="button"
                               href="index.php?action=affich_modifier_conge_venir&amp;id=<?= $conge['id_conge'] ?>"><i class="fa fa-edit"></i> Modifier</a>
                            <a class="btn btn-success" type="button"
                               href="index.php?id=<?=$conge['id_conge']?>&amp;action=genererTitreConge" style="margin-top: 5px; margin-left: 6px;"><i class="fa fa-save"></i> Générer titre des congés</a>
