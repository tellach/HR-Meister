...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Liste des congés présents
            </h1>
            <a type="button" class="btn btn-success" href="index.php?action=affich_ajout_conge" style="margin: 10px;"><i class="fa fa-plus"></i> Ajouter un congé</a>
        </section>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <a class="btn btn-danger" type="button"
                               href="index.php?action=arreter_conge&amp;id=<?= $conge['id_conge'] ?>"><i class="fa fa-stop"></i> Arrêter</a>
                            <a class="btn btn-warning" type="button"
                               href="index.php?action=affich_modifier_conge_prez&amp;id=<?= $conge['id_conge'] ?>"><i class="fa fa-edit"></i> Modifier</a>
                            <a class="btn btn-success" type="button"
                               href="index.php?id=<?=$conge['id_conge']?>&amp;action=genererTitreConge" style="margin-top: 5px;"><i class="fa fa-save"></i> Générer titre des congés</a>
                        </td>
                    </tr>
                    <?php
                }
